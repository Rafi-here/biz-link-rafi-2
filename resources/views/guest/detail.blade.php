...
@endphp
<x-layout.guest :title="$data->judul. ' - '.(optional(json_decode(\Storage::get('website.json'), true))['title'] ?? 'title')" :desc="$sentence" :tags="$data->articles->articletag" :footer="false" :category="$category">
